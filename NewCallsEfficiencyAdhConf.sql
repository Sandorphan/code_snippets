...
0, 0, 0, 0
FROM MICampaignSupport.dbo.tblACDDataSummaryDaily 
...
UPDATE tblinSpireCallsFeedCurrent
SET StaffTime = CASE WHEN StaffTime - (OBDStaffTime + IBDStaffTime + Aux1Time + Aux2Time) < 0 THEN 0 ELSE
							StaffTime - (OBDStaffTime + IBDStaffTime + Aux1Time + Aux2Time) END
...
MICampaignSupport.dbo.tblAdheranceDaily B
